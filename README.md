...
Current Bugs:
- Opening cutscene does not work when spamming through the messages. I think I can fix this by having the handleClick interact with the displayText, but this is pretty low priority for me. Don't go clicking. ✅ RESOLVED BY REMOVING TEXT EFFECTS
